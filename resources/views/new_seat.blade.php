        ...
        <div class="container">
            <form method="POST" action="/seats">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="isle_seats">
                                Isle Seats
                            </label>
                            <input type="number" name="isle_seats" min="1" max="10" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="form-group">
                            <label for="window_seats">
                                Window Seats
                            </label>
                            <input type="number" name="window_seats" min="1" max="10" class="form-control" required>
                        </div>
                    </div>
                </div>
                <div class="row">
