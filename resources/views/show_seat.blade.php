            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form method="POST" action="/seats/{{ $seat->id }}">
                            @csrf
                            @method('DELETE')
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <p>Bus Number: {{ $seat->bus_id }}</p>
                    <p>Taken By: @if($seat->user_id == null) {{ "N/A" }} @else {{ $seat->user_id }} @endif</p>
                    <p>Window Seat: @if($seat->isWindowSeat) {{ "Yes" }} @else {{ "No" }} @endif</p>
                </div>
            </div>

            <a href="/seats/{{ $seat->id }}/edit" class="btn btn-primary">Edit</a>
            <a href="/seats" class="btn btn-secondary">Back</a>
