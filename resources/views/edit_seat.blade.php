        ...
        <div class="container">
            <form method="POST" action="/seats/{{ $seat->id }}">
                ...
                <div class="row">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <label for="window_seat">
                                Window Seat
                            </label>
                            <select class="form-control" name="window_seat">
                                <option value="1" @if($seat->isWindowSeat){{ "selected" }} @endif>
                                    Yes
                                </option>
                                <option value="0" @if(!$seat->isWindowSeat){{ "selected" }} @endif>
                                    No
                                </option>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="form-group">
                            ...
                            <a href="/seat" class="btn btn-secondary">Cancel</a>
                        </div>
                    </div>
                </div>
